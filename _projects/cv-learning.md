...
Andrea Rizzi a,b,1, Paolo Carloni a,c,1, Michele Parrinello b,1

FEP benefits from machine learning. I start from [Rizzi, Carloni and Parrinello's paper](https://pmc.ncbi.nlm.nih.gov/articles/PMC10655219/) on free energies from force fields to write my [TFEP notes](/pdf_docs/Notes_on_TFEP.pdf). Soon to come are
[CV learning notes](/path/to/cv-notes).
